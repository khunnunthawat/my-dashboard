      ...
      <div>
        ...
        <div className='text-center'>
          <div className='flex items-center justify-center mt-4 mb-6'>
            ...
            <button class='text-5xl rounded-full w-10 text-center focus:outline-none text-blue-500'>
              +
            </button>
          </div>
          <button
            class=' text-white focus:outline-none px-4 py-1 rounded-md bg-gray-300'
          >
            Reset
          </button>
        </div>
